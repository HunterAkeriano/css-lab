...
.gradient-wipe__bar {
  position: absolute;
  inset: -20% -60%;
  background: linear-gradient(90deg, color-var-alpha('color-primary', 0.25), color-var-alpha('color-secondary', 0.25));
...
@keyframes wipe {
  ...
  20% { opacity: 0.9; }
  60% { transform: translateX(40%) rotate(12deg); opacity: 0.8; }
